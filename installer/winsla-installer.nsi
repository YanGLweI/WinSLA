...
; ─── 基本信息 ───────────────────────────────────────────────
Name "WinSLA v2.2.0"
OutFile "WinSLA-v2.2.0-Setup.exe"
...
Section "Core Files" SecCore
    ...
    WriteRegStr HKLM "Software\WinSLA" "Version" "2.2.0"
...
Section "Initialize Policy Registry" SecPolicy
    ...
    DetailPrint "  ✓ Set EmergencyRequiresReason=1 (emergency login requires reason by default)"
SectionEnd
